...
$app->get('/personaDescargaArchivo/:NomArchivo', function ($NomArchivo) {
    $filePSath=($_SERVER['DOCUMENT_ROOT'].'/ApoautisApis/Documentos/Personas/documentos/' . $NomArchivo);
    if(!empty($NomArchivo) && file_exists($filePSath)){
        // Define headers
...
$app->post('/persona', function () use ($app) {
    ...
    if (isset($_FILES['file'])) {
        ...
        $ruta_destino_archivo = "C:/xampp/htdocs/ApoautisApis/Documentos/Personas/documentos/$originalName";
        $archivo_ok = move_uploaded_file($_FILES['file']['tmp_name'], $ruta_destino_archivo);
    }

    if (isset($_FILES['fileFoto'])) {
        $originalNameFoto = $_FILES['fileFoto']['name'];
        $ruta_destino_archivo_Foto = "C:/xampp/htdocs/ApoautisApis/Documentos/Personas/fotos/$originalNameFoto";
        $archivo_ok = move_uploaded_file($_FILES['fileFoto']['tmp_name'], $ruta_destino_archivo_Foto);
    }
    ...
    if ($tipo == "post") {
        ...
        $No_identidad = $_POST['No_identidad'];
        $Documento_id =$originalName;
        $Fotografia= $originalNameFoto;
        ...
        /////////////////////////////////////////////
        $Cod_ficha_general = $_POST['Cod_ficha_general'];
        $Carnet_discapacidad = $_POST['Carnet_discapacidad'];
        $Acceso_computadora = $_POST['Acceso_computadora'];
        $Acceso_internet = $_POST['Acceso_internet'];
        $Bono_discapacidad = $_POST['Bono_discapacidad'];
        $Instituto_procedencia = $_POST['Instituto_procedencia'];
        $Permanencia_institucion = $_POST['Permanencia_institucion'];
        $Nivel_academico = $_POST['Nivel_academico'];
        $Telefono_instituto = $_POST['Telefono_instituto'];
        $Correo_instituto = $_POST['Correo_instituto'];
        /////////////////////////////////////////////////
        $Cod_ficha_inclusion = $_POST['Cod_ficha_inclusion'];
        $Cod_tipo_inclusion = $_POST['Cod_tipo_inclusion'];
        $Cod_tipo_institucion = $_POST['Cod_tipo_institucion'];
        $Nombre_institucion_empresa = $_POST['Nombre_institucion_empresa'];
        $Direccion_institucion = $_POST['Direccion_institucion'];
        $Telefono_institucion =$_POST['Telefono_institucion'];
        $Correo_electronico_institucion =$_POST['Correo_electronico_institucion'];
        $Fecha_ingreso = $_POST['Fecha_ingreso'];
        $Grado_academico = $_POST['Grado_academico'];
        $Seguimiento_inclusivo = $_POST['Seguimiento_inclusivo'];
        $Tiempo_seguimiento_inclusivo = $_POST['Tiempo_seguimiento_inclusivo'];
        $Cargo_desempeñar = $_POST['Cargo_desempeñar'];
        $Fecha_matricula = $_POST['Fecha_matricula'];
        ////////////////////////////////////////////////////
        $Cod_estado_nutricional = $_POST['Cod_estado_nutricional'];
        $Agudeza_visual = $_POST['Agudeza_visual'];
        $Agudeza_auditiva = $_POST['Agudeza_auditiva'];
        $Condicion_oral_deficiente = $_POST['Condicion_oral_deficiente'];
        $Esquema_vacunacion = $_POST['Esquema_vacunacion'];
        $Anemia = $_POST['Anemia'];
        $Alergia = $_POST['Alergia'];
        $Descripcion_alergias = $_POST['Descripcion_alergias'];
        $Enfermedad_cronica = $_POST['Enfermedad_cronica'];
        $Descripcion_enf_cronica = $_POST['Descripcion_enf_cronica'];
        $Seguimiento_medico = $_POST['Seguimiento_medico'];
        $Medicacion = $_POST['Medicacion'];
        $Nombre_medicamento = $_POST['Nombre_medicamento'];
        $Dosis = $_POST['Dosis'];
        $Tiempo_ingesta_medicacion = $_POST['Tiempo_ingesta_medicacion'];
        $Seguimiento_terapia_alternativa = $_POST['Seguimiento_terapia_alternativa'];
        $Tipo_terapia_alternativa = $_POST['Tipo_terapia_alternativa'];
        //////////////////////////////////////////////////////////////////////
        $Cod_parentesco = $_POST['Cod_parentesco'];
        $Cod_nivel_academico = $_POST['Cod_nivel_academico'];
        ...
        $Descripcion_enfermedades_cronicas = $_POST['Descripcion_enfermedades_cronicas'];
        $Ingreso_promedio_personal = $_POST['Ingreso_promedio_personal'];
        $Miembros_familia = $_POST['Miembros_familia'];
        $Ingreso_promedio_familiar =$_POST['Ingreso_promedio_familiar'];
      ...
      '$Fotografia'";
       ...
       $outputString = str_replace(" ", "", $params);

        $query = "Call beneficiarios($outputString)";
        $result = mysqli_query($con, $query);
        $error = mysqli_error($con);
    ...
    if ($tipo == "update") {
        ...
        $outputString = str_replace(" ", "", $params);
        $query = "call editbeneficiarios($outputString)";
        $result = mysqli_query($con, $query);
        $error = mysqli_error($con);
        $respuesta = [
            'error' => false,
